...
import problemSolutionImage from "./toto_problem_solution_1788662667367.jpg";
...
import videoDemoImage from "./poster_toto.jpg";
import videoToto from "./video_toto.mp4";

export const productImages = {
  hero: heroImage,
  problemSolution: problemSolutionImage,
  cleansingWand: cleansingWandImage,
  heatedSeat: heatedSeatImage,
  warmAir: warmAirImage,
  remoteWall: remoteWallImage,
  hotelSuite: hotelSuiteImage,
  actualFront: actualFrontImage,
  actualSide: actualSideImage,
  videoDemo: videoDemoImage,
  videoToto: videoToto,
};
